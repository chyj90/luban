...
INSERT IGNORE INTO STKO (MANDT, STLTY, STLNR, STLAL, DATUV, DATUB, STLST, STLAN, STLTX, BMENG, BMEIN) VALUES
('100', 'M', '00000001', '01', '2024-01-01', '9999-12-31', '01', '01', 'FG-MOTOR-01 BOM', 100.000, 'EA'),
('100', 'M', '00000002', '01', '2024-01-01', '9999-12-31', '01', '01', 'FG-GEARBOX-01 BOM', 100.000, 'EA'),
('100', 'M', '00000003', '01', '2024-01-01', '9999-12-31', '01', '01', 'FG-ASSEMBLY-01 BOM', 100.000, 'EA');

INSERT IGNORE INTO STPO (MANDT, STLTY, STLNR, STLKN, STVKN, IDNRK, MENGE, MEINS, POSTP, AUSCH) VALUES
-- FG-MOTOR-01 BOM: 需要 2 种原材料
('100', 'M', '00000001', 1, 0, 'RM-STEEL-01',  50.000, 'KG', 'L', 2.0),
('100', 'M', '00000001', 2, 0, 'RM-ALLOY-01',  30.000, 'KG', 'L', 1.5),
('100', 'M', '00000001', 3, 0, 'PM-BEARING-01', 4.000, 'EA', 'L', 0.0),
-- FG-GEARBOX-01 BOM: 需要 3 种原材料
('100', 'M', '00000002', 1, 0, 'RM-STEEL-01',  80.000, 'KG', 'L', 2.0),
('100', 'M', '00000002', 2, 0, 'RM-ALLOY-01',  20.000, 'KG', 'L', 1.5),
('100', 'M', '00000002', 3, 0, 'PM-BEARING-01', 8.000, 'EA', 'L', 0.0),
-- FG-ASSEMBLY-01 BOM: 需要 2 种半成品
('100', 'M', '00000003', 1, 0, 'FG-MOTOR-01',   1.000, 'EA', 'L', 0.0),
('100', 'M', '00000003', 2, 0, 'FG-GEARBOX-01', 1.000, 'EA', 'L', 0.0);
