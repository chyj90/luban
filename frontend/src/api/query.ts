...
export async function executeSql(datasourceId: number, sql: string, multi?: boolean, allowDdl?: boolean) {
  return post<any>('/queries/execute', { datasourceId, sql, multi: multi || undefined, allowDdl: allowDdl || undefined });
}
